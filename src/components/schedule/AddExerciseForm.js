...
const AddExerciseForm = ({ handleExerciseAdd, handleExerciseFormToggle }) => {
  ...
  const onSubmit = (e) => {
    ...
    handleExerciseAdd({ id: uuidv4(), name, workout });
    setName('');
    setWorkout('');
  }
  return (
      ...
      <form className="space-y-8 divide-y divide-gray-200" onSubmit={onSubmit}>
        <div className="space-y-8 divide-y divide-gray-200 sm:space-y-5">
          <div className="pt-8 space-y-6 sm:pt-10 sm:space-y-5">
            <div>
              <h3 className="text-lg leading-6 font-medium text-gray-900">Add new exercise for segment</h3>
              <p className="mt-1 max-w-2xl text-sm text-gray-500">This will create a new workout for this segment.</p>
            </div>
